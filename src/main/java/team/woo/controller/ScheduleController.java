...
public class ScheduleController {
    ...
    public String addSchedule(
        ...
        if (loginMember != null) {
            schedule = new Schedule(name, difficulty, importance, urgency, restTime, preferenceTime, stress, loginMember.getId(), taskType, estimatedTime);
        } else {
            schedule = new Schedule(name, difficulty, importance, urgency, restTime, preferenceTime, stress, taskType, estimatedTime);
        }
