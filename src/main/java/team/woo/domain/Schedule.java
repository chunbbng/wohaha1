...
//    private LocalDate deadLine;
    ...
    public Schedule(String name, int difficulty,
                    int importance, int urgency, String restTime, String preferenceTime, int stress, Long memberId, TaskType taskType, double estimatedTime) {
        this.name = name;
    ...
    public Schedule(String name, int difficulty,
                    int importance, int urgency, String restTime, String preferenceTime, int stress, TaskType taskType, double estimatedTime) {
        this.name = name;
        this.difficulty = difficulty;
        this.importance = importance;
        this.urgency = urgency;
